          ...
          <div className={style.workLab}>
              ...
              <div
                ...
                <div className={style.info}>
                  ...
                  <div className={style.hidden}>
                    <div className={style.back} onClick={() => setSelectedProject(null)}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={`bi bi-arrow-90deg-left ${style.back}`} viewBox="0 0 16 16">
            ...
            <div className={style.things}>
              <div
                ...
                <Wavy className={style.wavy} />
                <div className={style.info}>
                  <div className={style.projName}>OptoPulse</div>
                  <br />
            ...
            <div className={style.desc}>
              <div className={style.dot}></div>&#x3C; Hobbies /&#x3E;
            </div>
          </div>
        </div>
        {/* Other things:
